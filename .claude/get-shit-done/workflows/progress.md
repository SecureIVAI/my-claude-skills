...
```bash
INIT=$(node "/workspaces/my-claude-skills/.claude/get-shit-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "/workspaces/my-claude-skills/.claude/get-shit-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "/workspaces/my-claude-skills/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "/workspaces/my-claude-skills/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
DEBT=$(node "/workspaces/my-claude-skills/.claude/get-shit-done/bin/gsd-tools.cjs" audit-uat --raw 2>/dev/null)
```
