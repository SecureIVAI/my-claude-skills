...
<!-- For checkpoint task examples and patterns, see @/workspaces/my-claude-skills/.claude/get-shit-done/references/checkpoints.md -->
...
See `/workspaces/my-claude-skills/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/workspaces/my-claude-skills/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/workspaces/my-claude-skills/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
