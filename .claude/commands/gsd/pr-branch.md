...
<execution_context>
@/workspaces/my-claude-skills/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @/workspaces/my-claude-skills/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
