...
<execution_context>
@/workspaces/my-claude-skills/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/workspaces/my-claude-skills/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
