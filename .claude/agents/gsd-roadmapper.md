...
Reference full template: `/workspaces/my-claude-skills/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspaces/my-claude-skills/.claude/get-shit-done/templates/state.md`.
