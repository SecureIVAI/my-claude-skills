...
Use template from `/workspaces/my-claude-skills/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/workspaces/my-claude-skills/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/workspaces/my-claude-skills/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
